...
import pyDataverse.models
from pyDataverse import rest
from pyDataverse.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(pyDataverse.models, klass)
